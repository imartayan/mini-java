...
public class Test {
    ...
    private static String[] invalidFiles = { "tests/error/TypecheckNotInitialized.java",
            "tests/error/BinaryTree-error.java", "tests/error/BubbleSort-error.java",
            "tests/error/Factorial-error.java", "tests/error/LinearSearch-error.java",
            "tests/error/MoreThan4-error.java", "tests/error/QuickSort-error.java",
